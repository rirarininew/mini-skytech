...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ url('img/apple-icona.png') }}">
  ...
  <link href="{{ url('css/now-ui-dashboard.css?v=1.3.0') }}" rel="stylesheet" />
...
<body class="{{ $class ?? '' }}">
  ...
  <script src="{{ url('js/now-ui-dashboard.min.js?v=1.3.0') }}" type="text/javascript"></script>
