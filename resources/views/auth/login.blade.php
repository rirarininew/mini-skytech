        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="input-group no-border form-control-lg {{ $errors->has('password') ? ' has-danger' : '' }}">
                    ...
                    <input placeholder="Password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Password') }}" type="password" value="secret123" required>
                </div>
