          ...
          <div class="card-body">
            <div class="toolbar">
              <table class="table">
                ...
                <tr>
                  <td>
                    <form action="{{ route('posting.cariuser') }}" method="GET">
                      <input type="text" class="form-control pull-left" name="cariuser" placeholder="Search by USER ID">
                  </td>
                  <td>
                  ...
                  <td></td>
                  <td>
                    <a type="button" class="btn btn-secondary btn-round text-white pull-right" href="{{ route('posting.cariuser') }}">refresh</a>
                  </td>
                </tr>
                </tbody>
